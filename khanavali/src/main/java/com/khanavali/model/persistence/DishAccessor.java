...
public class DishAccessor {
	 ...
	 @Bean
	    ...
	    public static void main(String[] args) {
	        ...
	        repository.save(new Dish("Kesari bath", "Sweet sooji halwa", "Roasted rava and sweetened", "http://localhost:8080/images/001.png",1.0d,20.0d,1.0d,1,true));
	        repository.save(new Dish("Idli", "Steamed rice cakes", "Steamed rice cakes", "http://localhost:8080/images/002.png",1.0d,20.0d,1.0d,1,true));
	        repository.save(new Dish("Vada", "Fied lentil cakes", "Fried lentil cakes", "http://localhost:8080/images/003.png",1.0d,20.0d,1.0d,1,true));
	        repository.save(new Dish("Khara bath", "Savoury sooji halwa", "Roasted rava and spiced", "http://localhost:8080/images/004.png",1.0d,20.0d,1.0d,1,true));
